...
// console.log(user?.role, "from dynamic dashboard")
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-slate-800 bg-blue-500/80 dark:bg-slate-950/80 backdrop-blur-md transition-colors duration-300">
