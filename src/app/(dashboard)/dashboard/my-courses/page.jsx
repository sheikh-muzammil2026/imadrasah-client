    ...
    <table className="w-full text-left border-collapse min-w-[1050px]">
      ...
      <thead className="hidden md:table-header-group">
        <tr className="bg-slate-50/80 border-b border-slate-200/60 text-slate-500 text-xs font-bold uppercase tracking-wider select-none">
          ...
          <th className="py-4 px-6 min-w-[220px]">Course Name</th>
          <th className="py-4 px-6 min-w-[180px]">Category</th>
          <th className="py-4 px-6 min-w-[150px]">Level</th>
          <th className="py-4 px-6 min-w-[120px]">Price</th>
          <th className="py-4 px-6 min-w-[150px]">Status</th>
      ...
      <tbody className="divide-y divide-slate-100 text-sm block md:table-row-group">
        ...
        {myCourses?.map((course, index) => (
          ...
          >
            ...
            {/* Course Name */}
            <td className="block md:table-cell py-3 px-4 md:py-5 md:px-6">
              <span className="md:hidden text-xs text-slate-500 block mb-1">Course</span>
            ...
            {/* Category */}
            <td className="block md:table-cell py-3 px-4 md:py-5 md:px-6 text-slate-600 font-medium">
              <span className="md:hidden text-xs text-slate-500 block mb-1">Category</span>
              {course?.subject || "N/A"}
            </td>

            {/* Level */}
            <td className="block md:table-cell py-3 px-4 md:py-5 md:px-6">
              <span className="md:hidden text-xs text-slate-500 block mb-1">Level</span>
            ...
            {/* Price */}
            <td className="block md:table-cell py-3 px-4 md:py-5 md:px-6 text-slate-700 font-semibold">
              <span className="md:hidden text-xs text-slate-500 block mb-1">Price</span>
              ${course?.fee || 0}
            </td>

            {/* Status */}
            <td className="block md:table-cell py-3 px-4 md:py-5 md:px-6">
              <span className="md:hidden text-xs text-slate-500 block mb-1">Status</span>
            ...
            {/* Actions */}
            <td className="block md:table-cell py-3 px-4 md:py-5 md:px-6 md:text-right">
              <span className="md:hidden text-xs text-slate-500 block mb-2">Actions</span>
